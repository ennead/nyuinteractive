...
$(function () { // wait for document ready
  ...
  function updateBox0 () {
    ...
    $("#diagramFront").attr('src', 'assets/diagrams/Section/fullsection.png').stop(true,true).hide().delay(200).fadeIn("slow");
  ...
  function updateBox1 (e) {
    ...
    if (e.type == "enter") {
      ...
      $("#diagramBack").attr('src', backDiagramURL);
      $("#diagramFront").attr('src', 'assets/diagrams/Section/public_section.png').stop(true,true).hide().delay(200).fadeIn("slow");
