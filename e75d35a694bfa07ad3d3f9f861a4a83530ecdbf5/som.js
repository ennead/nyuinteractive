...
function updateBox0(){
  ...
  closeHotspot();
   ...
   $("#diagramFront").attr('src', 'assets/diagrams/SOM/01.png').stop(true,true).hide().fadeIn("slow");
   ...
   $("#pl2,#pl3").removeClass("activeLink").addClass("progressLink")
  ...
  function updateBox1 (e) {
    ...
    if (e.type == "enter") {
      ...
      $("#pl1,#pl3").removeClass("activeLink").addClass("progressLink")
  ...
  function updateBox2 (e) {
    if (e.type == "enter") {
      ...
      $("#pl1,#pl2").removeClass("activeLink").addClass("progressLink")
